...
//lpm_add_sub DEVICE_FAMILY="Cyclone II" LPM_DIRECTION="ADD" LPM_REPRESENTATION="SIGNED" LPM_WIDTH=8 ONE_INPUT_IS_CONSTANT="NO" dataa datab overflow result
...
`endif
	...
	wire	[7:0]	wire_result_int;

	assign
		wire_result_int = dataa + datab;
	assign
		result = wire_result_int[7:0],
		overflow = ~(dataa[7:7] ^ datab[7:7]) & (dataa[7:7] ^ wire_result_int[7:7]);
endmodule //lpm_add_8bit_add_sub
//VALID FILE
...
module lpm_add_8bit (
	...
	lpm_add_8bit_add_sub	lpm_add_8bit_add_sub_component (
				.dataa (dataa),
				.datab (datab),
				.overflow (sub_wire0),
				.result (sub_wire1));
